  ...
  render() {
    ...
    return (
      <div className="component weather">
        <div
          className={`weather__heading ${headerPos} ${
            this.state.activeTab === "map"
              ? "weather__heading--map-overlay"
              : null
          }`}
        >
          ...
          <div className="weather__btn-parent">
            <button
              ...
              className={`weather__btn ${
                this.state.activeTab === "map" ? "active" : ""
              }`}
            >
              Map
            </button>
            <button
              onClick={() => {
                this.changeTab("alerts");
              }}
              className={`weather__btn ${
                this.state.activeTab === "alerts" ? "active" : ""
              }`}
            >
              Alerts
            </button>
            <button
              onClick={() => {
                this.changeTab("cities");
              }}
              className={`weather__btn ${
                this.state.activeTab === "cities" ? "active" : ""
              }`}
            >
              Cities
            </button>
            {this.props.disasterType === "Earthquake" ? (
              <button
                onClick={() => {
                  this.changeTab("event");
                }}
                className={`weather__btn ${
                  this.state.activeTab === "event" ? "active" : ""
                }`}
              >
                Event
              </button>
