  ...
  render() {
    return (
      ...
      >
        ...
        >
          <button
            className="state-form__exit-btn"
            onClick={e => {
              e.preventDefault();
              this.props.toggleForm();
            }}
          ...
          <div className="state-form__label-input-parent">
            ...
            <input
              ...
              type="text"
              ref={textInput => (this.stateName = textInput)}
          ...
          <div className="state-form__label-input-parent">
            ...
            <input
              className="state-form__input"
              type="text"
              ref={textInput => (this.twitterList = textInput)}
              placeholder="Twitter List Url"
            />
          </div>
          ...
          <div className="state-form__label-input-parent">
            ...
            <textarea
              className="state-form__input"
              ref={textInput => (this.rawData = textInput)}
              placeholder="State Name"
            />
          </div>

          <button type="submit" className="state-form__submit-btn">
            Submit
          </button>
        </form>
      </div>
